...
<head>
    <meta charset="UTF-8">
    <meta name="mit" content="2024-01-10T20:36:08-03:00+194946">
    ...
    <?php else : ?>
        <article class="footer_optout">
            <div class="footer_optout_content content">
                ...
                <a href="?file=auth-register" class="footer_optout_btn gradient gradient-green gradient-hover radius icon-check-square-o">Quero controlar</a>
            </div>
        </article>
    <?php endif; ?>
